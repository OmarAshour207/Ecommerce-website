...
class CityDatatable extends DataTable
{
    ...
    {   // This query can't search in it need to modify
        return City::query()->with('country_id')->select('cities.*');
        
        // $country = City::with('country_id')
        //                 ->select('cities.*')
        //                 ->whereHas('country_id', function(){
        //     if (request()->has('country_id') && request()->get('country_id') != null ) {
        //             $country_id = array_filter($request->country_id);
        //             if(count($country_id) > 0) {
        //                 $q->whereIn('country_id.country_name_'.session('lang'), $request->get('country_id'));
        //             }  
        //         }
        // });
        //     return $country;
    ...
    public function html()
    {
        return $this->builder()
                    ...
                    ->parameters([
                        ...
                        'buttons'   => [
                            [
                                'text' => '<i class="fa fa-plus"></i> '.trans('admin.create_city') ,
