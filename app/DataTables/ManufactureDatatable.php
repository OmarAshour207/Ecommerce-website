    ...
    public function html()
    {
        return $this->builder()
                    ...
                    ->parameters([
                        ...
                        'buttons'   => [
                            [
                                'text' => '<i class="fa fa-plus"></i> '.trans('admin.create_manufacture') ,
    ...
    protected function getColumns()
    {
        return [
            [
                ...
                'name'  => 'manufacture_name_ar',
                'data'  => 'manufacture_name_ar',
                'title' => trans('admin.name_ar'),
            ],[
                'name'  => 'manufacture_name_en',
                'data'  => 'manufacture_name_en',
