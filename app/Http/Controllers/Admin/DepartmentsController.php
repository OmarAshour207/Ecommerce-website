...
class DepartmentsController extends Controller
{
    ...
    {
        return view('admin.departments.create',['title'=> trans('admin.create_dep')]);
    }
    ...
    public function store()
    {
        $data = $this->validate(request(),[
            ...
            'dep_name_ar'          => trans('admin.department_name_ar'),
            'dep_name_en'          => trans('admin.department_name_en'),
            'parent'               => trans('admin.parent_id'),
            'icon'                 => trans('admin.icon'),
            'description'          => trans('admin.dep_description'),
            'keyword'              => trans('admin.dep_keyword'),        
        ]);
