  ...
  <div class="box-body">
    {!! Form::open([ 'url' => aurl('states/'.$state->id), 'method' => 'put']) !!}
      ...
      <div class="form-group">
        ...
        {!! Form::select('country_id',App\Model\Country::pluck('country_name_'.session('lang'),'id'),$state->country_id, ['class' => 'form-control country_id','placeholder'=>trans('admin.choose_country')]) !!}
      </div>
      <div class="form-group">
