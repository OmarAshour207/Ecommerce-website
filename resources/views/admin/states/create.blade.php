  ...
  <div class="box-body">
    {!! Form::open(['route' => 'states.store']) !!}
      ...
      <div class="form-group">
        ...
        {!! Form::select('country_id',App\Model\Country::pluck('country_name_'.session('lang'), 'id') , old('country_id'), ['class' => 'form-control country_id','placeholder'=>trans('admin.choose_country')]) !!}
      </div>
      <div class="form-group">
      ...
      {!! Form::submit(trans('admin.create_state'),['classs' => 'btn btn-primary']) !!}
    {!! Form::close() !!}
  </div>
</div>
