...
<!--               <i class="fa fa-angle-left pull-right"></i> -->
        ...
        <li class="treeview {{ active_menu('admin')[0] }}">
          ...
          <ul class="treeview-menu" style="{{ active_menu('admin')[1] }}">
            <li class="active"><a href="{{ aurl('admin') }}"><i class="fa fa-users"></i> {{ trans('admin.admin_accounts') }}</a></li>
        ...
        <li class="treeview {{ active_menu('users')[0] }}">
          ...
          <ul class="treeview-menu" style="{{ active_menu('users_accounts')[1] }}">
            ...
            <li class=""><a href="{{ aurl('users') }}?level=user"><i class="fa fa-user"></i> {{ trans('admin.user') }}</a></li>
            <li class=""><a href="{{ aurl('users') }}?level=vendor"><i class="fa fa-industry"></i> {{ trans('admin.vendor') }}</a></li>
        ...
        <li class="treeview {{ active_menu('settings')[0] }}">
         ...
         <li class="treeview {{ active_menu('countries')[0] }}">
          ...
          <ul class="treeview-menu" style="{{ active_menu('countries')[1] }}">
            <li class="active"><a href="{{ aurl('countries') }}"><i class="fa fa-flag"></i> {{ trans('admin.countries') }}</a></li>
         ...
         <li class="treeview {{ active_menu('cities')[0] }}">
          ...
          <ul class="treeview-menu" style="{{ active_menu('cities')[1] }}">
            <li class="active"><a href="{{ aurl('cities') }}"><i class="fa fa-flag"></i> {{ trans('admin.cities') }}</a></li>
        ...
        <li class="treeview {{ active_menu('states')[0] }}">
          ...
          <ul class="treeview-menu" style="{{ active_menu('states')[1] }}">
            <li class="active"><a href="{{ aurl('states') }}"><i class="fa fa-flag"></i> {{ trans('admin.states') }}</a></li>
        ...
        <li class="treeview {{ active_menu('departments')[0] }}">
          ...
          <ul class="treeview-menu" style="{{ active_menu('departments')[1] }}">
            <li class="active"><a href="{{ aurl('departments') }}"><i class="fa fa-flag"></i> {{ trans('admin.departments') }}</a></li>
         ...
         <li class="treeview {{ active_menu('trademarks')[0] }}">
          <a href="#">
            <i class="fa fa-trademark"></i> <span>{{ trans('admin.trademarks') }}</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu" style="{{ active_menu('trademarks')[1] }}">
            <li class="active"><a href="{{ aurl('trademarks') }}"><i class="fa fa-trademark"></i> {{ trans('admin.trademarks') }}</a></li>
         ...
         <li class="treeview {{ active_menu('manufactures')[0] }}">
          ...
          <ul class="treeview-menu" style="{{ active_menu('manufactures')[1] }}">
            <li class="active"><a href="{{ aurl('manufactures') }}"><i class="fa fa-user"></i> {{ trans('admin.manufactures') }}</a></li>
         ...
         <li class="treeview {{ active_menu('shippings')[0] }}">
          ...
          <ul class="treeview-menu" style="{{ active_menu('shippings')[1] }}">
            <li class="active"><a href="{{ aurl('shippings') }}"><i class="fa fa-truck"></i> {{ trans('admin.shippings') }}</a></li>
        ...
        <li class="treeview {{ active_menu('malls')[0] }}">
          ...
          <ul class="treeview-menu" style="{{ active_menu('malls')[1] }}">
            <li class="active"><a href="{{ aurl('malls') }}"><i class="fa fa-building"></i> {{ trans('admin.malls') }}</a></li>
        ...
        <li class="treeview {{ active_menu('colors')[0] }}">
          ...
          <ul class="treeview-menu" style="{{ active_menu('colors')[1] }}">
            <li class="active"><a href="{{ aurl('colors') }}"><i class="fa fa-paint-brush"></i> {{ trans('admin.colors') }}</a></li>
        ...
        <li class="treeview {{ active_menu('sizes')[0] }}">
          ...
          <ul class="treeview-menu" style="{{ active_menu('sizes')[1] }}">
            <li class="active"><a href="{{ aurl('sizes') }}"><i class="fa fa-info-circle"></i> {{ trans('admin.sizes') }}</a></li>
        ...
        <li class="treeview {{ active_menu('weights')[0] }}">
          ...
          <ul class="treeview-menu" style="{{ active_menu('weights')[1] }}">
            <li class="active"><a href="{{ aurl('weights') }}"><i class="fa fa-info-circle"></i> {{ trans('admin.weights') }}</a></li>
        ...
        <li class="treeview {{ active_menu('products')[0] }}">
          ...
          <ul class="treeview-menu" style="{{ active_menu('products')[1] }}">
            <li class="active"><a href="{{ aurl('products') }}"><i class="fa fa-product-hunt"></i> {{ trans('admin.products') }}</a></li>
