...
<div class="box">
  ...
  <div class="box-body">
    {!! Form::open(['url' => aurl('departments/'.$department->id), 'method' => 'put','files'=>true]) !!}
      ...
      <div class="form-group">
        {!! Form::label('description',trans('admin.dep_description')) !!}
        {!! Form::textarea('description',$department->description, ['class' => 'form-control']) !!}
      </div>
      <div class="form-group">
        {!! Form::label('keyword',trans('admin.dep_keyword')) !!}
      ...
      <div class="form-group">
        ...
        <img src="{{ Storage::url($department->icon) }}" style="height: 100px;width: 50px">
        @endif
      </div>
      {!! Form::submit(trans('admin.save'),['classs' => 'btn btn-primary']) !!}
    {!! Form::close() !!}
  </div>
</div>
